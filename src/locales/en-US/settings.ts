export default {
  ...
  theme: {
    ...
    importTheme: "Import",
    exportTheme: "Export",
    importTitle: "Import Terminal Theme",
    importName: "Theme name",
    importNamePlaceholder: "Leave empty to auto-detect",
    importContent: "Theme content",
    importContentPlaceholder: "Paste .itermcolors or scheme JSON (Windows Terminal / xterm format)",
    importFileHint:
      "Accepts .itermcolors files and JSON schemes downloaded from iterm2colorschemes.com. Imported themes are saved under \"Custom themes\".",
    importPickFile: "Choose file",
    importApply: "Import & Apply",
    importSuccess: "Imported and applied \"{name}\"",
    importFailed: "Import failed: {reason}",
    exportSuccess: "Current theme JSON copied to clipboard",
    exportFailed: "Export failed: clipboard unavailable",
    customThemes: "Custom themes",
    deleteTheme: "Delete theme",
    deleteThemeConfirm: "Delete custom theme \"{name}\"?",
  },
  terminal: {
    title: "Terminal",
    ...
    tabShortcutsHint:
      "When enabled, tab shortcuts (new/close/switch/jump) are intercepted. Key bindings can be customized in the Shortcuts tab.",
    ...
    searchHotkey: "Enable search shortcut",
  ...
  shortcuts: {
    title: "Shortcuts",
    hint: "Click 'Record', then press the desired key combination. Press Esc to cancel, Backspace to clear.",
